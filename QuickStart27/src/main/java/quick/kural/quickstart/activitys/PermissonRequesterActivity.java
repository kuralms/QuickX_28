...
import quick.kural.quickstart.activitys.camera.CameraPreviewFragment;
import quick.kural.quickstart.activitys.contacts.ContactsFragment;
import quick.kural.quickstart.R;

@RuntimePermissions
public class PermissonRequesterActivity extends AppCompatActivity {
